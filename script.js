...
function displayResults(poke) {
    ...
    if (poke.types.length == 2) {
        sectionTwo.innerHTML = 'Type:' + ' ' + poke.types[0].type.name[0].toUpperCase() + poke.types[0].type.name.substring(1)+ '/' + poke.types[1].type.name[0].toUpperCase() + poke.types[1].type.name.substring(1);
    } else {
